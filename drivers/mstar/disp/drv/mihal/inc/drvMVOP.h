...
#define API_MVOP_DMS_DIPS_ADD_VERSION                 1
...
typedef struct DLL_PACKED
{
    ...
    MS_U8  u8FRAME_ID;
    MS_U32 u32MSB_FB_ADDR[2];         ///<0:8 bit y address, 1:8 bit uv address
    ...
    MS_U32 u32LSB_FB_ADDR[2];     ///<0:2 bit y address, 1:2 bit uv address
    ...
    MS_BOOL bDualDVEN;
    MS_U32  u32DualDV_EL_FB[2];        ///<0:8 bit EL y address, 1:8 bit EL uv address
    MS_U8   u8DualDV_EL_MIU[2];        ///<0:8 bit EL y miu select, 1:8 bit EL uv miu select

    MS_BOOL bEN3D;
    MS_U32  u32RViewFB[2];             ///<0:R view y address, 1:R view uv address
