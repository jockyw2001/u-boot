...
#define SCL_ERR(_fmt, _args...)       printf(_fmt, ## _args)
#define SCL_DBGERR(_fmt, _args...)    printf(_fmt, ## _args)


#elif defined (SCLOS_TYPE_LINUX_KERNEL)
...
#define SCL_DBGERR(_fmt, _args...)    printk(KERN_INFO _fmt, ## _args)
