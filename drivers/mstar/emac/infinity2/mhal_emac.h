...
#define REG_BANK_EMAC0                      0x1220 //0x1020
#define REG_BANK_EMAC1                      0x1221 //0x1021
...
// Base address here:
#define REG_ADDR_BASE						(0x1F000000+REG_BANK_EMAC0*0x200) 		// The register address base. Depends on system define.
