...
//------------------------------------------------------------------------------------------------
static void _SetPADVdd(U8_T u8Slot, BusVddEmType eBusVdd)
{
    ...
    if(eBusVdd ==EV_BUS_1_8V)
    {
        ...
        Hal_CARD_SetPADVdd(eIP, ePAD, EV_LOWVOL, 15);
...
static void mmc_set_ios(struct mmc *mmc)
{
    ...
    if(mmc->card_caps & MMC_MODE_HS)
    {
        ...
        Hal_CARD_SetBusTiming(eIP, EV_BUS_HS_SDR25);
        pr_sd_main("[HS] ");
    }
    else
    {
        ...
        else
        {
            ...
            Hal_CARD_SetBusTiming(eIP, EV_BUS_DEF_SDR12);
            pr_sd_main("[DS] ");
        }
    }
