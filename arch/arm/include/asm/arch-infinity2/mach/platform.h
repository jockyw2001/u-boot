...
#define MS_BASE_REG_TIMER2_PA              	GET_BASE_ADDR_BY_BANK(MS_BASE_REG_RIU_PA, 0x003040)
...
#define REG_ADDR_BASE_L3_BRIDGE             GET_BASE_ADDR_BY_BANK( MS_BASE_REG_RIU_PA, 0x101300 )
#define REG_ADDR_BASE_PADTOP                GET_BASE_ADDR_BY_BANK( MS_BASE_REG_RIU_PA, 0x102500 )
#define REG_ADDR_BASE_PADTOP1               GET_BASE_ADDR_BY_BANK( MS_BASE_REG_RIU_PA, 0x102600 )
#define REG_ADDR_PWM						GET_BASE_ADDR_BY_BANK( MS_BASE_REG_RIU_PA, 0x001A00 )
...
typedef enum
{
    DEVINFO_BOOT_TYPE_USB=0x00,
	DEVINFO_BOOT_TYPE_SPINAND,
	DEVINFO_BOOT_TYPE_SPINOR,
	DEVINFO_BOOT_TYPE_SD_3,
	DEVINFO_BOOT_TYPE_EMMC,
	DEVINFO_BOOT_TYPE_P_NAND,
	DEVINFO_BOOT_TYPE_UART,
	DEVINFO_BOOT_TYPE_NONE
}DEVINFO_BOOT_TYPE;
